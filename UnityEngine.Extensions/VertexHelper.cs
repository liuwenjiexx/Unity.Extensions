...
namespace UnityEngine.Extensions
{
    public static partial class UnityExtensions
    {
        ...
        public static void BuildVertexs(this VertexHelper vh, Vector2[] vertexs, Color color)
        {
            ...
            {
                point = vertexs[i];
                vert.position = new Vector2(point.x, point.y);
                vert.color = color;
                vh.AddVert(vert);
            }
            int[] indices;

            var tr = new Triangulator(vertexs);
